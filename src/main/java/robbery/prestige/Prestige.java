...
public class Prestige implements CommandExecutor {
    ...
    private static final long basePrestige = 1_750_000_000L;
    private static final long baseIncrement = 250_000_000L;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        ...
        } else if (balance < getPrestigeValue(p)) {
    ...
    public static double getPrestigeValue(PlayerData p) {
        int prestige = p.getPrestige();
        if (prestige == 0) return 700_000_000;
        else if (prestige == 1) return 1_500_000_000L;
        else if (prestige == 2) return 2_250_000_000L;
        else return basePrestige + baseIncrement*prestige;
    }
