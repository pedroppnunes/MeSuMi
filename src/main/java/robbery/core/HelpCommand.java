...
public class HelpCommand implements CommandExecutor {
    ...
    public void loadHelp() {
        helpCategories.put("Robbery", Arrays.asList(
                ...
                new HelpCommandData("/prestige", "Automatically prestiges if you have the requirements"),
        ...
        helpCategories.put("Other", Arrays.asList(
                ...
                new HelpCommandData("/gkit, /gkits", "Displays all of the Daily/Weekly Kits that every player and vips can get"),
