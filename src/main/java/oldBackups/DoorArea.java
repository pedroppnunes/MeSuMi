...
public class DoorArea {
    ...
    public void setMaterial(Player player, Material material) {
        ...
        BlockData blockData = material.createBlockData(); // <-- Use Bukkit's BlockData

        Bukkit.getScheduler().runTask(Robbery.getInstance(), () -> {
...
KeyManager:
    ...
    public final static Keys STORE6 = new Keys("Casino",1_000_000,6,"&#FF0000&lC&#FC3300&la&#F96600&ls&#F79900&li&#F4CC00&ln&#F1FF00&lo","store6",List.of(new DoorArea(new Location(w, 20328,101,20017),new Location(w, 20328,107,20016)),
                                                                                                                                                                                        ...
                                                                                                                                                                                        new DoorArea(new Location(w,20316,101,20005),new Location(w,20317,107,20005)),
