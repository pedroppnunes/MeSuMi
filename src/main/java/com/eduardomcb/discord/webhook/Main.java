...
import static com.bencodez.votingplugin.VotingPluginMain.plugin;
        ...
        new WebhookManager()
                ...
                .setListener(new WebhookClient.Callback() {
                    ...
                    public void onSuccess(String response) {
                        plugin.getLogger().info("Message sent successfully");
                    }

                    @Override
                    public void onFailure(int statusCode, String errorMessage) {
                        plugin.getLogger().warning("Code: " + statusCode + " error: " + errorMessage);
                    }
